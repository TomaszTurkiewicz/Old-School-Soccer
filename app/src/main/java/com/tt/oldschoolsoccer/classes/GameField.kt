...
class GameField {
    ...
    private fun setAvailableMovesHard() {
        ...
        field[4][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[5][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = false, downLeft = false, left = false, upLeft = false)
        ...
        field[8][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[9][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = true, left = false, upLeft = false)
        ...
        field[11][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[12][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[13][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[14][1].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        ...
        field[4][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[5][2].setAvailableMoves(up = false, upRight = true, right = true, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[9][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = true, upLeft = true)
        field[10][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[11][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[12][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = true, down = true, downLeft = true, left = false, upLeft = false)
        field[13][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = true, left = false, upLeft = false)
        field[14][2].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)

        for(i in 3..19){
            field[0][i].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
            field[1][i].setAvailableMoves(up = false, upRight = true, right = true, downRight = true, down = false, downLeft = false, left = false, upLeft = false)
            field[13][i].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = true, left = true, upLeft = true)
            field[14][i].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        }
        ...
        field[1][20].setAvailableMoves(up = false, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[2][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[3][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[4][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[5][20].setAvailableMoves(up = true, upRight = true, right = true, downRight = true, down = false, downLeft = false, left = false, upLeft = true)
        field[9][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = true, left = true, upLeft = true)
        field[10][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[11][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[12][20].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[13][20].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[14][20].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)

        field[0][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[1][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[2][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[3][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[4][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[5][21].setAvailableMoves(up = false, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[6][21].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[7][21].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[8][21].setAvailableMoves(up = true, upRight = true, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[9][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = true)
        field[10][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[11][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[12][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[13][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[14][21].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)

        field[0][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[1][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[2][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[3][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[4][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[5][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[6][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[7][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[8][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[9][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[10][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[11][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[12][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[13][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
        field[14][22].setAvailableMoves(up = false, upRight = false, right = false, downRight = false, down = false, downLeft = false, left = false, upLeft = false)
